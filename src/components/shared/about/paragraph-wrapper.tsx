...
const ParagraphWrapper: React.FC = () => {
	return (
		<div className="paragraph-wrapper">
			<Paragraph delay={0}>
				Finding out that websites are made with <Hl>HTML</Hl> and <Hl>CSS</Hl> got me{" "}
				<Hl>excited</Hl> about <Hl>web development</Hl>. That made me really interested in{" "}
				<Hl>computers and programming</Hl>. Now here I am, <Hl>20 years old</Hl> and{" "}
				<Hl>pursuing my dreams</Hl> as a <Hl>second year BSIT student</Hl>.
			</Paragraph>
			<Paragraph delay={0.5}>
			...
			<Paragraph delay={1}>
				When working on my <Hl>personal projects</Hl>, I love using <Hl>Next.js App Router</Hl> and{" "}
				<Hl>Tailwind CSS</Hl> with <Hl>shadcn/ui</Hl>. These tools make me <Hl>super productive</Hl>
				! Though I‘m comfortable with this <Hl>stack</Hl>, many developers suggest learning to love{" "}
