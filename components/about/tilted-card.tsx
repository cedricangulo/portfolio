		...
		>
			...
			>
				<Image
					...
					className="absolute top-0 left-0 object-cover will-change-transform transform-[translateZ(0)] border border-border hover:border-primary rounded-xl p-1 shadow-sm transition-colors duration-300"
				/>
